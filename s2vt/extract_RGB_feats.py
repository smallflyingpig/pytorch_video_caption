...
def main():
    num_frames = 80
    vgg_model = '/root/workspace/caffe/models/vgg_16/VGG_ILSVRC_16_layers.caffemodel'
    vgg_deploy = '/root/workspace/caffe/models/vgg_16/VGG_ILSVRC_16_layers_deploy.prototxt'
    video_path = '/root/Downloads/YouTubeClips/'
